 ...
 */
final class v419DropStackRequestAction extends ItemStackRequestAction{
	...
	public function getSource() : v419ItemStackRequestSlotInfo{ return $this->source; }
	...
	public function write(ByteBufferWriter|PacketSerializer $out) : void{
		...
		$serializer->putBool($this->randomly);
	}
}
