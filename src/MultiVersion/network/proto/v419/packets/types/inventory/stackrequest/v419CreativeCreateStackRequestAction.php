...
/**
 * Legacy format used by protocol 419: only creative item net ID is present.
 */
final class v419CreativeCreateStackRequestAction extends ItemStackRequestAction{
