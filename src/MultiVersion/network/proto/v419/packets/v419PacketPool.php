...
class v419PacketPool extends PacketPool{
	...
	public function __construct(){
		...
		$this->registerPacket(new v419PlayerSkinPacket());
		$this->registerPacket(new v419RequestChunkRadiusPacket());
		$this->registerPacket(new v419SetActorDataPacket());
		$this->registerPacket(new v419SetActorMotionPacket());
		$this->registerPacket(new v419LevelSoundEventPacket());
	}
}
